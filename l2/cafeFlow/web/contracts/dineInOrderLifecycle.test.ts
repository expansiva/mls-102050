...
import type { CafeFlowAddOrderItemInput, CafeFlowAddOrderItemOutput, CafeFlowCreateKitchenTicketInput, CafeFlowCreateKitchenTicketOutput, CafeFlowCreateOrderInput, CafeFlowCreateOrderOutput, CafeFlowUpdateOrderStatusInput, CafeFlowUpdateOrderStatusOutput, CafeFlowUpdateTableStatusInput, CafeFlowUpdateTableStatusOutput } from './dineInOrderLifecycle.js';
...
type ExpectedCafeFlowUpdateTableStatusInput = {
  status: "available" | "occupied" | "disabled";
  currentChargesTotal: number;
  openedAt?: string;
  closedAt?: string;
};
type ExpectedCafeFlowUpdateTableStatusOutput = {
...
type _CafeFlowUpdateTableStatusInput = Assert<Equal<CafeFlowUpdateTableStatusInput, ExpectedCafeFlowUpdateTableStatusInput>>;
type _CafeFlowUpdateTableStatusOutput = Assert<Equal<CafeFlowUpdateTableStatusOutput, ExpectedCafeFlowUpdateTableStatusOutput>>;
